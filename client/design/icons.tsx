    ...
    case "settings":
      return (
        <svg {...svgProps}>
          ...
          <path d="M10 1.5l.6 1.8c.5.1 1 .3 1.5.5l1.5-1.1 1.7 1.7-1.1 1.5c.2.5.4 1 .5 1.5l1.8.6v2.4l-1.8.6c-.1.5-.3 1-.5 1.5l1.1 1.5-1.7 1.7-1.5-1.1c-.5.2-1 .4-1.5.5l-.6 1.8H8.8l-.6-1.8c-.5-.1-1-.3-1.5-.5l-1.5 1.1-1.7-1.7 1.1-1.5c-.2-.5-.4-1-.5-1.5l-1.8-.6V8.8l1.8-.6c.1-.5.3-1 .5-1.5L3.5 5.2l1.7-1.7 1.5 1.1c.5-.2 1-.4 1.5-.5l.6-1.8h1.2z" />
        </svg>
      );
    case "search":
      return (
